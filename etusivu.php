...
<div class="row" data-equalizer data-equalize-on="medium">
		  <div class="small-12 medium-6 large-6 columns pysty panel" data-equalizer-watch>
		 <a href="<?php echo get_site_url(); ?>/fi/ajankohtaista#uutiset"><h2>Uutiset</h2></a>  
				...
				<p><a href="<?php echo get_site_url(); ?>/fi/ajankohtaista#uutiset">Lisää uutisia &#8594;</a></p>
			</div>           

			<div class="small-12 medium-6 large-6 columns panel" data-equalizer-watch> 
		...
		<a href="<?php echo get_site_url(); ?>/fi/ajankohtaista#tapahtumat"><ul class="orbit-container">
				...
				<?php echo the_post_thumbnail(array(700,350)); ?></div>
				</li>
				<?php endwhile;?>
</ul></a>
</div>
